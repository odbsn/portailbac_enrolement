        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/stats/**").hasAnyAuthority(Role.ADMIN.name(), Role.SCOLARITE.name(), Role.INSPECTEUR_ACADEMIE.name(), Role.DEMSG.name(), Role.FINANCE_COMPTA.name())
                                .requestMatchers("/api/v1/candidats/**").hasAnyAuthority(Role.CHEF_ETABLISSEMENT.name(), Role.AGENT_DE_SAISIE.name(), Role.ADMIN.name(), Role.SCOLARITE.name(), Role.INSPECTEUR_ACADEMIE.name())
