...
const ValidationCandidat = () => {
    ...
    const loadCandidats = useCallback(async () => {
        ...
        try {
            ...
            const response = await CandidatureService.getSummarizeEtabNotReceptionned(edition?.edition);
                ...
                import('xlsx').then((xlsx) => {
                    const worksheet = xlsx.utils.json_to_sheet(
                        rawCandidats.map(row => ({
                            ...
                            Téléphone: row.phone,
                            Dossiers_en_Attente: row.totalDossiers
        ...
        const header = (
            <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
                <div className="flex flex-wrap gap-3">
                     <div className="flex flex-wrap gap-3">
                                                    <h4>Listing des établissements pas encore réceptionnés</h4>
                                                </div>
