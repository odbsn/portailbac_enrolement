...
const ValidationCandidat = () => {
    ...
    const loadCandidats = useCallback(async () => {
        ...
        try 
        {
            ...
            const response = await CandidatureService.getSummarizeOperatorsByEtab(prog?.edition, etablissement?.id);
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            <div className="flex flex-wrap gap-3">
                 <div className="flex flex-wrap gap-3">
                                                <h4>Les réceptionnistes de l&apos;etablissement : {etablissement?.name}</h4>
                                            </div>
        ...
        const SBodyTemplate = (rowData) => {
            return (
                <div className="flex flex-column gap-1">
                    {rowData.operators.map((op, index) => (
                        <div key={`${op.login}-${op.id?.toString() || index}`} className="text-sm">
                            <strong
                                style={{
                                    ...
                                    borderRadius: "14px",
                                    fontWeight: "800",
                                    fontSize: "1.2rem",   // ⬅️ plus gros
                                    textAlign: "center",
                                    minWidth: "60px"
                                }}
                            >
                                {op.firstname} {op.lastname} {op.phone}
                            </strong>
                        ...
                        <Toolbar className="mb-4" left={leftToolbarTemplate}></Toolbar>
                                ...
                                <DataTable
                                                                                                    ...
                                                                                                    >
                                                                                                                ...
                                                                                                                <Column field="operators" header="Réceptionnistes" body={SBodyTemplate} headerStyle={{ minWidth: '5rem' }} />
