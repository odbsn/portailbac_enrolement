...
const ValidationCandidat = () => {
    ...
    const selectedEtat =
        etat !== undefined && etat !== null ? Number(etat) : null;

    const code =
        typeof serieCode === "string" 
        ? serieCode : serieCode?.code;

    const centExa =
        typeof selectedCExa === "string"
        ? selectedCExa
        : selectedCExa?.name;

    return rawCandidats.filter(c => {
        const matchEtat = selectedEtat !== null ? 
        c.decision === selectedEtat : true;

        const matchSerie = code ? 
        c.serie?.code === code : true;

        const matchCentre = centExa ? 
        c.centreExamen?.name?.toLowerCase() === centExa.toLowerCase(): true;

        return matchEtat && matchSerie && matchCentre;
    });
    }, [rawCandidats, etat, serieCode, selectedCExa]);
    ...
    useEffect(() => {
            if (etablissement?.typeEtablissement?.code === 'I' && Number(prog?.edition)) 
            {
                CandidatureService.getCentreExamForI(etablissement?.id, Number(prog?.edition)).then((response) => {
    ...
    const editProduct = (candidat) => 
    {
        ...
        console.log(new Date(candidatFormatted.date_birth).getFullYear());
        console.log(candidatFormatted.year_registry_num);

        if (candidatFormatted.year_registry_num > (Number(prog?.edition - 7)))
        {
            console.log(Number(prog?.edition - 7))
            console.log(candidatFormatted.year_registry_num)
            setIsJudge(true);
        }
                                                ...
                                                <div className="field col-12">
                                                    <fieldset
                                                        ...
                                                        >
                                                            ...
                                                            <div style={{ width: '200px' }}>
                                                                <label htmlFor="etablissement"><h6 className="m-0">Choisir un centre d&apos;examen</h6></label>
                                                                <Dropdown
                                                                    value={selectedCExa}
                                                                    ...
                                                                    optionValue="name"
                                                                    onChange={(e) => {
                                                                        const centreObj = centreExamen_.find(c => c.name === e.value);
                                                                        setSelectedCExa(centreObj);
                                                                    }}
                                                            ...
                                                            <label htmlFor="serieCode"><h6 className="m-0">Choisir une série</h6></label>
                                                            <Dropdown
                                                                showClear
                                                                id="serieCode"
                                                                name="serieCode"
                                                            ...
                                                            <div style={{ width: '250px', marginTop: '10px' }}>
                                                                <DownloadPDFButton session={prog?.edition} />
                                                            </div>
                                                        </div>
                                                        </fieldset>
                                                        
                                                </div>
                                                <div className="mb-0 field col-12">
                                                    {faeb?.enabled && faeb?.representative && etablissement && (
                                                            <>
                                                                <span style={{ backgroundColor: "black", color: "white", padding: "1px 8px", borderRadius: "5px", fontSize: "13px" }}>
                                                                    <b>Mandataire : {faeb.representative} ({faeb.phone})</b>
                                                                </span>
                                                                <span style={{ backgroundColor: "purple", color: "white", padding: "1px 8px", borderRadius: "5px", fontSize: "13px" }}>
                                                                    <b>Candidat (s) présenté (s) : {etablissement?.typeCandidat?.name}</b>
                                                                </span>
                                                                <span style={{ backgroundColor: "maroon", color: "white", padding: "1px 8px", borderRadius: "5px", fontSize: "13px" }}>
                                                                    <b>Centre d&apos;examen par défaut : {etablissement?.centreExamen?.name}</b>
                                                                </span><br />
                                                                <span style={{ backgroundColor: "blue", color: "white", padding: "1px 8px", borderRadius: "5px", fontSize: "13px" }}>
                                                                    <b>Vignette (s) de 1000 F payée (s) au Trésor : {faeb.count_1000_EF}</b>
                                                                </span>
                                                                <span style={{ backgroundColor: "orange", color: "black", padding: "1px 8px", borderRadius: "5px", fontSize: "13px" }}>
                                                                    <b>Epreuve (s) facultative (s) saisie (s) : {compteEF?.facListA + compteEF?.facListB}</b>
                                                                </span>
                                                                {faeb.count_1000_EF < (compteEF?.facListA + compteEF?.facListB) ? 
                                                                (
                                                                    <span style={{ backgroundColor: "red", marginTop: "5px", display: "inline-block", color: "white", padding: "1px 8px", borderRadius: "5px", fontSize: "13px" }}>
                                                                        <b>Attention !!! un dépassement de {(compteEF?.facListA + compteEF?.facListB) - faeb.count_1000_EF} épreuve (s) facultative (s) à régulariser</b>
                                                                    </span>
                                                                ):(
                                                                        <span
                                                                            style={{
                                                                ...
                                                                <br />
                                                                <span style={{ backgroundColor: "blue", color: "white", padding: "1px 8px", borderRadius: "5px", fontSize: "13px" }}>
                                                                    <b>Vignette (s) de 5000 F payée (s) au Trésor : {faeb.count_5000}</b>
                                                                </span>
                                                                <span style={{ backgroundColor: "orange", color: "black", display: "inline-block", padding: "1px 8px", borderRadius: "5px", fontSize: "13px" }}>
                                                                    <b>Candidats (s) enrôlé (s) : {compteEF?.candidats}</b>
                                                                </span>
                                                               {
                                                                    faeb.count_5000 < compteEF?.candidats ? (
                                                                        ...
                                                                        >
                                                                            <b>
                                                                                Attention !!! un dépassement de{" "}
                                                                                {compteEF?.candidats - faeb.count_5000} candidat(s) à régulariser
                                                                            </b>
                                                                        </span>
                                                                    ) : (
                                                                        <span
    ...
    const DownloadPDFButton: React.FC<DownloadPDFButtonProps> = ({session}) => {
    const handleDownload = async () => {
        setLoading(true);
        try {
        await CandidatureService.getPVReception(session, user?.login, etablissement?.code);
        } 
        catch (error) 
        {
        ...
        etablissement && (
            ...
            label={loading 
                ? "Téléchargement..." 
                : `Télécharger le PV de ${etablissement.code}`
            }
            icon="pi pi-download"
                ...
                {candidats && candidats.length > 0 && (
                    <div className="flex flex-wrap gap-1 mb-0">
                        ...
                        <div className="bg-cyan-100 text-black-800 px-2 py-2 rounded-xl">
                            ...
                            {serieCode && (
                            <span className="bg-cyan-100 text-black-800 px-2 py-2 rounded-xl">
                                <strong>Série : {serieCode}</strong>
                            </span>
                            )}
                        </div>
                        )}
                ...
                <div className="formgrid grid">
                    ...
                    <div className="field col-3">
                        <label style={{
                            ...
                            <InputText readOnly className="p-inputtext-sm" value={formik.values.centreExamen?.name}
                                style={{
                                    fontWeight: 'bold',
                                    color: 'black',
                                }}/>
                        ...
                        <div className="formgrid grid">
                            ...
                            <div className="field col-2">
                                                     <label style={{
                                                        ...
                                                        <b>
                                                            <span className="text-red-600">*</span> Lieu de Naiss.
                                                        </b>
                                                    </label>
                                                    <InputText
                                    ...
                                    <div className="formgrid grid">
                                        <div className="field col-4">
                                            <Dropdown
                                                ...
                                                style={{
                                                    backgroundColor: getColor(Number(radioValue)),
                                                    fontWeight: 'bold',
                                                    color: getColor2(Number(radioValue))
                                                }}
                                                />
                                        </div>
                                         <div className="field col-4">
                                                ...
                                                <Button severity="info" icon="pi pi-save" label="Cliquez pour enregistrer l'état du dossier de candidature" className="mr-2" type="submit"/>
                                                )}
...
const selectedOption = options.find(option => option.name === formik.values.eprFacListB) || null;
    ...
    return (
        <ProtectedRoute allowedRoles={['SCOLARITE', 'RECEPTIONNISTE', 'ADMIN']}>
