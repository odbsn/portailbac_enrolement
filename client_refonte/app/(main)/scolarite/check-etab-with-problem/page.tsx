...
const ValidationCandidat = () => {
    ...
    const [receptionnistes, setReceptionnistes] = useState(null);
    ...
    useEffect(() => {
        CandidatureService.getAllReceptionniste().then((response) => {
            setReceptionnistes(response);
        });
    }, []);
    ...
    const loadCandidats = useCallback(async () => {
        ...
        try {
            ...
            const response = await CandidatureService.getSummarizeEtabWithProblem(edition?.edition);
                                    ...
                                    <div className="formgrid grid">
                                                <div className="field col-12">
                                                    <fieldset
                                                        ...
                                                        >
                                                            ...
                                                            <label htmlFor="serieCode"><h6 className="m-0">Choisir une édition</h6></label>
                                                            <Dropdown
                                                                                                    showClear
                                                                                                    id="edition"
                                                                                                    name="edition"
                                                ...
                                                <div className="mb-0 field col-12">
                                                    {faeb?.enabled && faeb?.representative && etablissement && (
                                                            <>
                                                                <span style={{ backgroundColor: "green", color: "white", padding: "1px 8px", borderRadius: "5px", fontSize: "13px" }}>
                                                                ...
                                                                <span style={{ backgroundColor: "blue", color: "white", padding: "1px 8px", borderRadius: "5px", fontSize: "13px" }}>
                                                                    <b>Epreuve (s) facultative (s) payée (s) au Trésor : {faeb.count_1000_EF}</b>
                                                                </span>
                                                                ...
                                                                (
                                                                    <span style={{ backgroundColor: "red", marginTop: "5px", display: "inline-block", color: "white", padding: "1px 8px", borderRadius: "5px", fontSize: "13px" }}>
                                                                        <b>Attention !!! vous avez rajouté {(compteEF?.facListA + compteEF?.facListB) - faeb.count_1000_EF} épreuve (s) facultative (s)</b>
                                                                    </span>
                                                                )}
                                                            </>
                                                        )}     
  ...
  session: number;
    ...
    return (
        ...
        <Button
            ...
            label={
            rowData.decision === 1
                ? "Dossier Validé"   // vert clair
                : rowData.decision === 2
                ? "Dossier Rejeté"    // rouge tomate
                : "Dossier en Attente"   // par défaut (jaune/orange)
            }
            rounded
            severity={
            rowData.decision === 1
                ...
                : rowData.decision === 2
                ? "danger"    // rouge tomate
                : "warning"   // par défaut (jaune/orange)
            }
            className="mr-2"
    ...
    const exportExcel2 = () => {
                import('xlsx').then((xlsx) => {
                    const worksheet = xlsx.utils.json_to_sheet(
                        rawCandidats.map(row => {

                        let observation1 = '';

                        let observation2 = '';

                        if (row.cdt > row.count_5000) {
                            observation1 = 'Dépassement';
                        } 
                        else 
                        {
                            observation1 = 'Conforme';
                        }

                        if (row.totalEF > row.count_1000_EF) {
                            observation2 = 'Dépassement';
                        } 
                        else 
                        {
                            observation2 = 'Conforme';
                        }
                        ...
                        return {
                            ...
                            EF_Inscrite: row.totalEF,
                            Vignette_1000: row.count_1000_EF,
                    ...
                    saveAs(blob, `Check Incoherence Vignette ${prog?.edition}.xlsx`);
                });
            };
        ...
        const header = (
            <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
                <div className="flex flex-wrap gap-3">
                     <div className="flex flex-wrap gap-3">
                                                    <h4>Check Incohérence Vignette</h4>
                                                </div>
                                                ...
                                                {((edition) && (
                                                    <div className="flex gap-3">
                                                        <Button
                                                            ...
                                                            label="Exporter la liste pour le check Incohérence Vignette"
                                                        />
                                                    </div>
                                                ))}
                ...
                <span className="block mt-0 md:mt-0 p-input-icon-left">
                    ...
                    <InputText
                        ...
                        placeholder="Recherche par nom établissement..."
                    />
                </span>
            </div>
        );
    ...
    const SBodyTemplate = (rowData) => {
                return (
                    <>
                        ...
                        >Téléphone : {rowData?.phone}</span>
                        
                    </>
                );
            };
        
    const cdtTemplate = (rowData) => {
                return (
                    <>
                        <span style={{
                                display: "inline-block",
    ...
    const v5000Template = (rowData) => {
                return (
                    <>
                        <span style={{
                                display: "inline-block",
                                backgroundColor:
                                    rowData.count_5000 < rowData.cdt ? "red" : "green",
                                    color: rowData.count_5000 < rowData.cdt ? "white" : "white",
                                padding: "4px 10px",
                                borderRadius: "10px",
                                fontWeight: "bold",
                                fontSize: "0.9rem",
    ...
    const v1000Template = (rowData) => {
                return (
                    <>
                        <span style={{
                                display: "inline-block",
                                backgroundColor: 
                                    rowData.count_1000_EF < rowData.totalEF ? "red" : "green",
                                    color: rowData.count_1000_EF < rowData.totalEF ? "white" : "white",
                                padding: "4px 10px",
                                borderRadius: "12px",
                                fontWeight: "bold",
                                fontSize: "0.9rem",
    ...
    const opsBodyTemplate = (rowData) => {
                return (
                    <>
                        <span className="p-column-title">Opérateur</span>
                        {rowData.operator}
                    </>
                );
            };
                        ...
                        <Toolbar className="mb-4" left={leftToolbarTemplate} right={rightToolbarTemplate}></Toolbar>
                                ...
                                <DataTable
                                                                                                    ...
                                                                                                    >
                                                                                                                ...
                                                                                                                <Column header="Candidat (s)" field="cdt" sortable body={cdtTemplate} headerStyle={{ minWidth: '5rem' }} />
                                                                                                                <Column header="V5000" field="count_5000" sortable body={v5000Template} headerStyle={{ minWidth: '5rem' }} />
                                                                                                                <Column header="EF" field="totalEF" sortable body={efTemplate} headerStyle={{ minWidth: '5rem' }} />
                                                                                                                <Column header="V1000 EF" field="count_1000_EF" sortable body={v1000Template} headerStyle={{ minWidth: '5rem' }} />
