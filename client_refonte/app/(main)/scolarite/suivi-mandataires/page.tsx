...
const ValidationCandidat = () => {
    ...
    const loadDatas = useCallback(async () => {
            ...
            try
            {
                    ...
                    {
                        console.log(edition)
                        const response = await ParametrageService.getAllMandataires(edition?.edition);
                ...
                {candidats && candidats.length > 0 && (
                    <div className="flex flex-wrap gap-3 mb-3">
                        <div className="bg-cyan-100 text-black-800 px-2 py-2 rounded-xl">
                            <strong>Suivi des mandataires du BAC {edition?.edition}</strong>
                        </div>
                ...
                <div className="field col-12">
                    ...
                    <div className="formgrid grid">
                        ...
                        <label htmlFor="payment_mode" className="font-bold">
                            <span className="text-red-600">*</span> Nom du mandataire
                        </label>
                ...
                <div className="col-12">
                    <div className="card">
                        ...
                        `}
                            ...
                            >
                                <Column field="etablissement.code" header="Etablissement" sortable body={oNBodyTemplate} headerStyle={{ minWidth: '10rem' }} />
                                <Column field="representative" header="Mandataire" body={rpBodyTemplate} headerStyle={{ minWidth: '5rem' }} />
