...
const ValidationCandidat = () => {
    ...
    const loadCandidats = useCallback(async () => {
        ...
        try {
            ...
            const response = await CandidatureService.getSummarizeEtabPartReceptionned(edition?.edition);
                ...
                import('xlsx').then((xlsx) => {
                    const worksheet = xlsx.utils.json_to_sheet(
                        rawCandidats.map(row => ({
                            ...
                            Téléphone: row.phone,
                            Dossiers_en_Attente: row.nbDossiersEnAttente
                    ...
                    saveAs(blob, `Listing des établissements partiellement receptionnés pour le BAC ${prog?.edition}.xlsx`);
                });
            };
        ...
        const header = (
            <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
                <div className="flex flex-wrap gap-3">
                     <div className="flex flex-wrap gap-3">
                                                    <h4>Etablissements partiellement réceptionnés</h4>
                                                </div>
                                                ...
                                                {((edition) && (
                                                    <div className="flex gap-3">
                                                        <Button
                                                            ...
                                                            label="Exporter la liste des établissements partiellement réceptionnés"
                                                        />
                                                    </div>
                                                ))}
