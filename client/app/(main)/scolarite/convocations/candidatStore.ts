...
export const setNavigating = (value: boolean) => {
  isNavigating = value;
};
...
export const useCandidatStore = create<CandidatState>()((set, get) => ({
  ...
  // Obtenir la stack trace complète
  const stack = new Error().stack;
  console.log("🧹 clearCurrentCandidat appelé");
  console.log("📍 Stack trace:");
  console.log(stack);
  
  // Alternative avec console.trace
  console.trace("🔍 clearCurrentCandidat - Trace détaillée");
