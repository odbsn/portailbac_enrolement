...
public class PaiementController
{
    ...
    @Operation(summary="Service de consultation des droits d'inscription")
    @GetMapping("/getAllDroitsInscription/{session}")
    public ResponseEntity<List<DroitInscription>> getAllDroitsInscription(@PathVariable Long session) {
        return ResponseEntity.ok(this.paiementService.getAllDroitsInscription(session));
    }

    @Operation(summary="CallBack destiné à OB")
