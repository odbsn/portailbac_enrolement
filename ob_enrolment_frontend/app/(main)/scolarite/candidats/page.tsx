...
const ValidationCandidat = () => {
    ...
    CandidatureService.getCandidatsForScolarite(
        lazyParams.page,
        lazyParams.rows,
        Number(prog.edition)
    )
...
const DownloadPDFButton: React.FC<DownloadPDFButtonProps> = ({ etablissementId, session, etablissementName }) => {
  ...
  const handleDownload = async () => {
    setLoading(true);
    try {
      await CandidatureService.getListByEtab(etablissementId, session, etablissementName, user?.login, "all", "dosNumber", "allCdt", null, null, null);
    } catch (error) {
  ...
  return (
    <Button
      label={loading ? "Téléchargement..." : "Télécharger la liste compléte de l'établissement"}
      icon="pi pi-download"
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            <div className="flex flex-wrap gap-3">
                <h5>Listing des candidats du BAC {prog?.edition}</h5>
            </div>
    ...
    const formik = useFormik({
            ...
            gender: Yup.string().required('Le genre est obligatoire'),
                        ...
                        place_birth: Yup.string()
                            ...
                            .matches(/^[a-zA-ZÀ-ÿ]+(?:[ '-][a-zA-ZÀ-ÿ]+)*$/, 'Le lieu de naissance est invalide')
                            .test('no-leading-space', 'Le lieu de naissance ne peut pas commencer par un espace', (value) => value && !value.startsWith(' '))
                            .test('no-trailing-space', 'Le lieu de naissance ne peut pas se terminer par un espace', (value) => value && !value.endsWith(' ')),
    ...
    //const handleMatiere4Change = useFormikLocalStorageDefault(formik, 'matiere4');
        ...
        const carouselItems2 = [
            <div key="step1">
            <h5 className="text-primary"><b>Données du dossier de candidature</b></h5>
                ...
                <div className="field col-7">
                    ...
                    <div className="formgrid grid">
                        ...
                        <label style={{
                                    fontWeight: 'bold',
                                    color: "black"
                                }}><b>Code Centre Etat Civil</b></label>
                        <InputText
                        ...
                        <label style={{
                                    fontWeight: 'bold',
                                    color: "black"
                                }}><b>Nom / Centre Etat-Civil</b></label>
                        <Dropdown
                            id="centreEtatCivil"
                    ...
                    <div className="field col-12">
                        ...
                        <div className="formgrid grid">  
                            ...
                            <div className="field col-2">
                                ...
                                />
                                {formik.touched.place_birth && typeof formik.errors.place_birth === 'string' && (
                                <small className="p-error">{formik.errors.place_birth}</small>
                                )}
                            </div>
                                    ...
                                    {formik.values.serie?.code !== 'F6' &&
                                        ...
                                        <fieldset className="custom-fieldset border-round-md text-sm border-blue-500">
                                                ...
                                                <div className="formgrid grid">
                                                    ...
                                                    {formik.values.serie?.code !== 'LA' && formik.values.serie?.code !== 'STIDD' && formik.values.serie?.code !== "L'1" && formik.values.serie?.code !== 'L1A'  && formik.values.serie?.code !== 'L1B' && formik.values.serie?.code !== 'S1A' && formik.values.serie?.code !== 'S2A' && (
                                                        <div className="field col-4">
                                                            <label style={{
                                                                fontWeight: 'bold',
                                                                color: "black"
                                                            }}>
                                                                <b><span className="text-red-600">* </span> SCIENCES (PC OU SVT)</b>
                                                            </label>
                                                            <Dropdown
                                                                disabled = {true}
                                                                showClear
                ...
                <div className="col-12">
                    <div className="card">
                        ...
                        <Toolbar className="mb-4" right={rightToolbarTemplate}></Toolbar>
                                ...
                                >
                                    <Column field="dosNumber" header="N° dossier" body={dNBodyTemplate} headerStyle={{ minWidth: '5rem' }} />
                                    <Column field="firstname" header="Prénom (s)" body={fNBodyTemplate} headerStyle={{ minWidth: '20rem' }} />
                                    <Column field="lastname" header="Nom" body={lNBodyTemplate} headerStyle={{ minWidth: '10rem' }} />
                                    <Column
                                        field="date_birth"
                                        header="Date Naiss."
                                    ...
                                    />
                                    <Column field="place_birth" header="Lieu Naiss." headerStyle={{ minWidth: '10rem' }} />
                                    <Column field="gender" header="Sexe" body={serieBodyTemplate} headerStyle={{ minWidth: '5rem' }} />
