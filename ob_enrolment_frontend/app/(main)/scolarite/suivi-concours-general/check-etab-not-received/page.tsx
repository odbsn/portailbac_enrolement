...
const ValidationCandidat = () => {
    ...
    const loadCandidats = useCallback(async () => {
        ...
        try {
            ...
            const response = await CandidatureService.getEtabNotSummarizeCGS(edition?.edition);
  ...
  session: number;
    ...
    const exportExcel2 = () => {
                import('xlsx').then((xlsx) => {
                    ...
                    saveAs(blob, `Listing des établissements pas encore receptionnés pour le BAC ${prog?.edition}.xlsx`);
                });
            };
        ...
        const header = (
            <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
                <div className="flex flex-wrap gap-3">
                     <div className="flex flex-wrap gap-3">
                                                    <h4>Listing des établissements pas encore réceptionnés CGS</h4>
                                                </div>
                                                ...
                                                {((edition) && (
                                                    <div className="flex gap-3">
                                                        <Button
                                                            ...
                                                            label="Exporter la liste des établissements non réceptionnés"
                                                        />
                                                    </div>
                                                ))}
    ...
    const SBodyTemplate = (rowData) => {
                return (
                    <>
                        ...
                        >Téléphone : {rowData?.telephone}</span>
                    ...
                    <div className="card">
                        ...
                        <Toolbar className="mb-4" left={leftToolbarTemplate} right={rightToolbarTemplate}></Toolbar>
                                ...
                                <DataTable
                                                                                                        ...
                                                                                                        header={header}
                                                                                                    >
                                                                                                                <Column field="etablissement" sortable header="Etablissement" body={SBodyTemplate} headerStyle={{ minWidth: '5rem' }} />
